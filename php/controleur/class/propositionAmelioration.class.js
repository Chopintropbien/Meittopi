...
function PropositionAmelioration(photo, titre, description, nbPersonneVotePour, nbPersonneVotreContre, nbPersonneVotePourMax, nbPersonneVotreContreMax, donsDonnee, nbDonsQuOnABesoin, utilisateurAime,  utlisateurAimePas, utilisateurDons, utilisateurAime, utilisateurAimePas, infoLienPropositionamelioration, infoLienPourDonnation){
	this.photo = photo;
	this.titre = titre;
	...
	this.utilisateurAime = utilisateurAime;
	this.utilisateurAimePas = utilisateurAimePas;
