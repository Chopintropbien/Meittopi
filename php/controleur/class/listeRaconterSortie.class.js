function ListeRaconterSortie(){
	...
	this.ajouteSortie = function(speudo, photoProfil, nomRestau, titre, description){
		
		this.sorties.push( new RaconterSortie(speudo, photoProfil, nomRestau, titre, description) );
	}
